...
<body>
                                ...
                                <div class="basic-form">
                                    ...
                                    <?php
                                      include "koneksi.php";
                                       ...
                                       mysqli_query($koneksi,"update pesanpem set baca='0' where nis='$nis'");
                                      $datad = mysqli_query($koneksi,"select * from pesanpem where nis='$nis'");
                                      ...
                                      ?>    
                                             ...
                                             <tr>
                                                 ...
                                                 <td align="right">
                                                    ...
                                                    <?php
                                                     $datad = mysqli_query($koneksi,"select * from pkl where nis='$nis'");
    ...
    ***********************************-->
    ...
    if(isset($_POST['simpan_kelas']))
    {
        ...
        mysqli_query($koneksi,"update siswa set chat_p='1' where nis='$nis'");
        ...
        echo"<script>window.location='pesan_pembimbing.php'</script>";
