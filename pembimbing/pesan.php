                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php
                                      ...
                                      $nip=$_SESSION['nip'];
                                      $no=1;
                                      $datad = mysqli_query($koneksi,"select * from siswa join pkl on siswa.nis=pkl.nis  where chat_p='1' and nip='$nip'");
                                      ...
                                      ?>
                                            ...
                                            <td>                               
                                                    ...
                                                    <a href="lihat_pesan.php?nip=<?php echo $data['nip']; ?>&&nis=<?php echo $data['nis']; ?>">  
