                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" name="id_kelas">
                                                        <option><?php echo $data['id_kelas'];?></option>
                                                        <?php
                                                        $datas = mysqli_query($koneksi,"select * from kelas");
                                                        while($datak = mysqli_fetch_array($datas))
                                                         { ?>
                                                        <option value="<?php echo $datak['id_kelas'];?>"><?php echo $datak['nama_kelas'];?></option>
                                                        <?php } ?>
                                                </select>
