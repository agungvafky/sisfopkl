            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tambah Siswa PKL</h4>
                                  <a href="pkl.php">
                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <td width="50">                               
                                                    ...
                                                    <a href="tentukan_pkl.php?nis=<?php echo $data['nis']; ?>">  
                                                        <button type="button" class="btn mb-1 btn-flat btn-outline-primary"><i class="fa fa-gear"></i></button>
                                                    </a>   
