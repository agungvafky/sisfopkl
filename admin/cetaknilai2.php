...
$query = mysqli_query($koneksi,"SELECT * FROM pkl join siswa on pkl.nis=siswa.nis join kelas on siswa.id_kelas=kelas.id_kelas join pembimbing on pkl.nip=pembimbing.nip join tempat on pkl.id_tempat=tempat.id_tempat where nilai!='0' and pembimbing.nip='$pembimbing' and tgl_mulai between '$tanggal_awal' AND '$tanggal_akhir' ORDER BY no DESC");
$html = ' <html>
