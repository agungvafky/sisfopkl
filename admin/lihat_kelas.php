                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php
                                      ...
                                      $datad = mysqli_query($koneksi,"select count(nis) as jumlah from siswa where id_kelas='$id_kelas' ");
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php
                                      include "koneksi.php";
                                      $no=1;
                                      $datad = mysqli_query($koneksi,"select * from siswa where id_kelas='$id_kelas'");
                                        while($data = mysqli_fetch_array($datad)){
                                      
                                      ?>
                                            <tr>
                                                <td width="10%"><?php echo $no;?></td>
                                                <td width="120"><img src="<?php echo $data['foto'];?>" width="100" height="150" ></td>
