                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Laporan Nilai Siswa Praktek Kerja Lapangan</h4>
                                    ...
                                    <p align="right">
                                         ...
                                         <a href="cetaknilai.php" target="_blank">
                              ...
                              <?php
                                ...
                                <br>
                                <a href="cetaknilai1.php?lokasi=<?php echo $lokasi ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                ...
                                <br>
                                <a href="cetaknilai2.php?pembimbing=<?php echo $pembimbing ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                                ;}
                                ...
                                <br>
                                <a href="cetaknilai3.php?lokasi=<?php echo $lokasi ?>&&pembimbing=<?php echo $pembimbing ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
                                ...
                                <br>
                                <a href="cetaknilai4.php?tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            ...
                            <?php
                             ;}
                                ...
                                <br>
                                <a href="cetaknilai5.php?kelas=<?php echo $kelas ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                             <?php ; }
                                ...
                                <br>
                                <a href="cetaknilai6.php?kelas=<?php echo $kelas ?>&&lokasi=<?php echo $lokasi ?>&&pembimbing=<?php echo $pembimbing ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
                                ...
                                <br>
                                <a href="cetaknilai7.php?keterangan=<?php echo $keterangan ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
                                ...
                                <br>
                                <a href="cetaknilai8.php?keterangan=<?php echo $keterangan ?>&&kelas=<?php echo $kelas ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
                                ...
                                <br>
                                <a href="cetaknilai9.php?keterangan=<?php echo $keterangan ?>&&lokasi=<?php echo $lokasi ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
                                ...
                                <br>
                                <a href="cetaknilai10.php?lokasi=<?php echo $lokasi ?>&&keterangan=<?php echo $keterangan ?>&&kelas=<?php echo $kelas ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
                                ...
                                <br>
                                <a href="cetaknilai11.php?pembimbing=<?php echo $pembimbing ?>&&keterangan=<?php echo $keterangan ?>&&kelas=<?php echo $kelas ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
                                ...
                                <br>
                                <a href="cetaknilai12.php?pembimbing=<?php echo $pembimbing ?>&&keterangan=<?php echo $keterangan ?>&&lokasi=<?php echo $lokasi ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
                                ...
                                <br>
                                <a href="cetaknilai13.php?kelas=<?php echo $kelas ?>&&pembimbing=<?php echo $pembimbing ?>&&keterangan=<?php echo $keterangan ?>&&lokasi=<?php echo $lokasi ?>&&tanggal_awal=<?php echo $tanggal_awal ?>&&tanggal_akhir=<?php echo $tanggal_akhir ?>" target="_blank">
                                    <button type="button" class="btn mb-1 btn-flat btn-outline-dark" ><i class="fa fa-print"></i>&nbsp; Cetak</button>
                                </a> 
                            <?php
                            ;}
